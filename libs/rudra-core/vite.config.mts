...
export default defineConfig(() => ({
  ...
  build: {
    ...
    rollupOptions: {
      external: ['react', 'react-dom', 'react/jsx-runtime', 'react/jsx-dev-runtime', 'clsx', 'gsap', 'tailwindcss', 'motion', 'motion/react', 'framer-motion', 'three', '@react-three/fiber', '@react-three/fiber'],
      output: {
